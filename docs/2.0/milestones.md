...
| --- | --- |
| 分支 | `refactor/2.0.0` |
| 当前里程碑 | **M2 ✅ 核心完成**（调度器验证通过，部分门禁待 UI 后补测） |
| 上次更新 | 2026-09-13 23:47 |
| 阻塞项 | 无 |

**下一步动作**：开 M3（Web UI）。M2 核心调度逻辑已验证（单账号补跑、自动调度、间隔控制），多账号/长时间门禁留待 UI 完成后用浏览器验证。
